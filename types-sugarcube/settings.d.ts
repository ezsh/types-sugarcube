...
declare interface ToggleDefinition extends SettingDefinition{
	/**
...
declare interface ListDefinition extends SettingDefinition{
	/**
	 * The array of items.
	 */
	list: any[];
...
declare interface RangeDefinition extends SettingDefinition {
	/**
	 * The minimum value.
	 */
	min: number;
...
export interface Settings {
	 ...
	 */
	addList(name: string, definition: ListDefinition): void;
